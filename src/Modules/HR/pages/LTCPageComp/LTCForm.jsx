...
const LtcForm = () => {
  ...
  const Divider = ({ thickness = '3px', color = '#ccc', margin = '20px 0' }) => (
  ...
  const [dependentsFields, setDependentsFields] = useState([{ fullName: "", age: "", reason: "" }]); 
  ...
  const handleDependentsChange = (value) => {
    ...
    setDependentsFields(new Array(count).fill({ fullName: "", age: "", reason: "" })); // Reset fields based on selected number
  };
 ...
 return (
    <div className="Ltc_container">
      <form onSubmit={handleSubmit}>
        ...
        <div className="grid-row">
           <div className="grid-col">
            <label className="input-label" htmlFor="blockyear">Block year</label>
            <div className="input-wrapper">
          ...
          <div className="grid-col">
            <label className="input-label" htmlFor="providentFundNo">Provident Fund No.</label>
            <div className="input-wrapper">
              <IdentificationCard size={20} />
              <input
                type="number"
          ...
          <div className="grid-col">
            <label className="input-label" htmlFor="basicPay">Basic Pay</label>
            <div className="input-wrapper">
              <Money size={20} />
              <input
                type="number"
        ...
        <div className="grid-row">
          <div className="grid-col">
            <label className="input-label" htmlFor="departmentSection">Department / Section</label>
            <div className="input-wrapper">
              <Building size={20} />
              <Select
                ...
                onChange={(value) => handleSelectChange(value, "departmentSection")}
                className="input"
                styles={selectStyles}
         ...
         <div className="grid-row">
  <div className="grid-col">
    <label className="input-label" htmlFor="date">(b) (i) If so, duration of leave applied for From:</label>
    <div className="input-wrapper">
    <Calendar size={20} />
    <input
      type="date"
  ...
  <div className="grid-col">
    <label className="input-label" htmlFor="date">To:</label>
    <div className="input-wrapper">
    <Calendar size={20} />
    <input
      type="date"
  ...
  <div className="grid-col">
    <label className="input-label" htmlFor="date">(ii) Date of departure of family, if not availing himself</label>
    <div className="input-wrapper">
    <Calendar size={20} />
    <input
      type="date"
  ...
  {/* Row 4: LTC Availability and Purpose */}
        <div className="grid-row"> <div className="grid-col">
            <label className="input-label" htmlFor="natureOfLeave">(c) Nature of Leave</label>
            <div className="input-wrapper">
              <Leaf size={20} />
              <Select
                id="natureOfLeave"
                ...
                data={[
                  ...
                  { value: "Special Casual Leave", label: "Special Casual Leave" },
          ...
          <div className="grid-col">
            <label className="input-label" htmlFor="purpose">(d) Purpose</label>
            <div className="input-wrapper">
              <Tag size={20} />
              <input
                type="text"
...
<div className="grid-row">
          ...
          {selectedPlace === "ElseWhere" && (
            <div className="grid-col">
              <label className="input-label" htmlFor="visitingPlace">Place where you are visiting:</label>
              <div className="input-wrapper">
                <input
                  type="text"
                  id="visitingPlace"
        ...
        <div className="grid-row">
          <div className="grid-col">
            <label className="input-label" htmlFor="modeOfTravel">Mode of Travel</label>
            <div className="input-wrapper">
              <Airplane size={20} />
              <Select
                id="modeOfTravel"
          ...
          <div className="grid-col">
            <label className="input-label" htmlFor="addressDuringLeave">Address During Leave</label>
            <div className="input-wrapper">
              <MapPin size={20} />
              <input
                type="text"
...
<h3>(i) Details of family members for whom L.T.C. for this block has already been availed:</h3>
<div className="grid-row">
  <div className="grid-col">
    <label className="input-label" htmlFor="selfName">(a) Self</label>
    <div className="input-wrapper">
      <User size={20} />
      <input
        type="text"
  ...
  <div className="grid-col">
    <label className="input-label" htmlFor="wifeName">(b) Wife</label>
    <div className="input-wrapper">
      <User size={20} />
      <input
        type="text"
  ...
  <div className="grid-col">
    <label className="input-label" htmlFor="Children">(c) Children</label>
    <div className="input-wrapper">
      <User size={20} />
      <input
        type="text"
  ...
  <div className="grid-col">
    <label className="input-label" htmlFor="numChildren">(c) Number of Family Members</label>
    <div className="input-wrapper">
        <Users size={20} />
        <div className="input-wrapper">
      <Select
  ...
  {numChildren > 0 && (
  <div>
    <h4 style={{ marginBottom: '20px', fontSize: '1.2rem', color: '#2d3748' }}>(ii) Details of family members who will avail L.T.C.</h4>
          ...
          <tr key={index}>
            ...
            <td>
              <input
                ...
                id={`childAge${index}`}
                value={child.age}
                onChange={(e) => handleChildInputChange(index, "age", e.target.value)}
...
<div className="grid-row">
  <div className="grid-col">
    <label className="input-label" htmlFor="numDependents">Number of Dependents</label>
    <div className="input-wrapper">
      <Users size={20} />
      <div className="input-wrapper">
        <Select
...
{numDependents > 0 && (
  <div>
    <h4 style={{ marginBottom: '20px', fontSize: '1.2rem', color: '#2d3748' }}>
      (d)Dependent parents, minor brothers, and sisters residing with the applicant:
    </h4>
          ...
          <tr key={index}>
            ...
            <td>
              <input
                ...
                onChange={(e) => handleDependentInputChange(index, "fullName", e.target.value)}
                className="input"
            ...
            <td>
              <input
                ...
                onChange={(e) => handleDependentInputChange(index, "reason", e.target.value)}
                className="input"
 ...
 <div className="grid-row">
  ...
  <div className="grid-col amount-advance">
    <label className="input-label" htmlFor="amount">Amount of advance required, if any:</label>
    <div className="input-wrapper">
      <Money size={20} />
      <input
        type="number"
  ...
  {/* Certified Details */}
  <div className="grid-col">
    <label className="input-label" htmlFor="certificationDetails">(i) Certified that family members for whom the L.T.C. is claimed are residing with me and are wholly dependent upon me.</label>
    <div className="input-wrapper">
      <input
        type="text"
...
<div className="grid-row">
  ...
  <div className="grid-col">
    <label className="input-label" htmlFor="previousLTCDate">Certified that the previous L.T.C. advance drawn by me on:</label>
    <div className="input-wrapper">
    <Calendar size={20} />
    <input
      type="date"
  ...
  <div className="grid-col">
    <label className="input-label" htmlFor="phoneNumber">Phone Number for contact:</label>
    <div className="input-wrapper">
    <Phone size={20} />
    <input
      type="tel"
